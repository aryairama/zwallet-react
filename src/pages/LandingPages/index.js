    ...
    <div>
            ...
            <div className={Style.boxheader}>
              <div>
                <p className={Style.big}>
                  ...
                  <span className={Style.bigBlue}>Time.</span>
                </p>
              </div>
      ...
      <div className={Style.about}>
        <div className={Style.aboutContent}>
          <p className={Style.big}>
            <span className={Style.bigBlue}>About</span> the Application
          </p>
          <p className={Style.descBox}>
      ...
      <div className={Style.partner}>
        <div className={Style.partnerDesc}>
          <p className={Style.big}>
            100+ <span className={Style.bigBlue}>Trusted</span> Partners.
          </p>
          <p className={Style.desc}>
      ...
      <div className={Style.feature}>
        ...
        <div className={Style.featureDesc}>
          <div className={Style.featureTitle}>
            <p className={Style.big}>
              All The <span className={Style.bigBlue}>Great</span> Zwallet
              Features.
            </p>
          </div>
          <div className={Style.featureCard}>
            <p className={Style.small}>
              <span className={Style.bigBlue}>1. </span>Small Fee
            </p>
            <p className={Style.desc}>
          ...
          <div className={Style.featureCard}>
            <p className={Style.small}>
              <span className={Style.bigBlue}>2. </span>Data Secured
            </p>
            <p className={Style.desc}>
          ...
          <div className={Style.featureCard}>
            <p className={Style.small}>
              <span className={Style.bigBlue}>3. </span>User Friendly
            </p>
            <p className={Style.desc}>
      ...
      <div className={Style.testimony}>
        <div className={Style.aboutContent}>
          <p className={Style.big}>
            What Users are <span className={Style.bigBlue}>Saying.</span>
          </p>
          <p className={Style.descBox}>
            We have some great features from the application and it’s totally
            free to use by all users around the world.
